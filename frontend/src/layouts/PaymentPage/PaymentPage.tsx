...
export const PaymentPage = () => {
    ...
    useEffect(() => {
        // Sayfa yüklendiğinde çalışan etkileşimli bir etki alanı (effect).
        const fetchFees = async () => {
            if (authState && authState.isAuthenticated) {
                // Oturum açmış kullanıcının ödeme bilgilerini çekme.
    ...
    async function checkout() {
        // Kredi kartı ödeme işlemi gerçekleştirilir.
        ...
        // Kredi kartı ödeme işlemi onaylanır.
        stripe.confirmCardPayment(
            ...
            if (result.error) {
                ...
                // Ödeme tamamlandı olarak işaretlenir.
